...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton bandportugal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bandportugal = findViewById(R.id.banportugal);
    ...
    public void cargarimagenes()
    {
        ...
        col1.setImageResource(pref.getInt("col1", col1.getResources().getIdentifier("armero", "drawable", getPackageName())));
        col2.setImageResource(pref.getInt("col2", col2.getResources().getIdentifier("falcao", "drawable", getPackageName())));
        col3.setImageResource(pref.getInt("col3", col3.getResources().getIdentifier("james", "drawable", getPackageName())));
        col4.setImageResource(pref.getInt("col4", col4.getResources().getIdentifier("ospina", "drawable", getPackageName())));
        arg1.setImageResource(pref.getInt("arg1", arg1.getResources().getIdentifier("di_maria", "drawable", getPackageName())));
        arg2.setImageResource(pref.getInt("arg2", arg2.getResources().getIdentifier("romeroarg", "drawable", getPackageName())));
        arg3.setImageResource(pref.getInt("arg3", arg3.getResources().getIdentifier("messiarg", "drawable", getPackageName())));
        arg4.setImageResource(pref.getInt("arg4", arg4.getResources().getIdentifier("higuain", "drawable", getPackageName())));
        por1.setImageResource(pref.getInt("por1", por1.getResources().getIdentifier("cr7", "drawable", getPackageName())));
        por2.setImageResource(pref.getInt("por2", por2.getResources().getIdentifier("liedsonportugal", "drawable", getPackageName())));
        por3.setImageResource(pref.getInt("por3", por3.getResources().getIdentifier("pepe", "drawable", getPackageName())));
        por4.setImageResource(pref.getInt("por4", por4.getResources().getIdentifier("porteroportugal", "drawable", getPackageName())));
        bra1.setImageResource(pref.getInt("bra1", bra1.getResources().getIdentifier("dida", "drawable", getPackageName())));
        bra2.setImageResource(pref.getInt("bra2", bra2.getResources().getIdentifier("neymar", "drawable", getPackageName())));
        bra3.setImageResource(pref.getInt("bra3", bra3.getResources().getIdentifier("ronaldihno", "drawable", getPackageName())));
        bra4.setImageResource(pref.getInt("bra4", bra4.getResources().getIdentifier("ronaldo", "drawable", getPackageName())));
        banbrasil.setImageResource(pref.getInt("banbrasil", banbrasil.getResources().getIdentifier("banderabrasil", "drawable", getPackageName())));
        bancolombia.setImageResource(pref.getInt("bancolombia", bancolombia.getResources().getIdentifier("banderacolombia", "drawable", getPackageName())));
        banarg.setImageResource(pref.getInt("banarg", banarg.getResources().getIdentifier("banderaargentina", "drawable", getPackageName())));
        bandportugal.setImageResource(pref.getInt("bandportugal", bandportugal.getResources().getIdentifier("banportugal", "drawable", getPackageName())));
    }
    ...
    public void ronaldo (View view)
    {
        ...
        if(contador8==2)
        {
            bra4.setImageResource(R.drawable.ronaldo1);
    ...
    public void cr7 (View view)
    {
        ...
        if(contador9==2)
        {
            por1.setImageResource(R.drawable.cr71);
        ...
        if(contador9==3)
        {
            por1.setImageResource(R.drawable.cr72);
    ...
    public void liedson (View view)
    {
        ...
        if(contador10==2)
        {
            por2.setImageResource(R.drawable.liedsonportugal1);
            imagenesmarcadas(por2,"liedsonportugal1");
            almacenarimagenes("por2","liedsonportugal1");
        }
        if (contador10==3)
        {
            por2.setImageResource(R.drawable.liedsonportugal2);
    ...
    public void banportugal (View view)
    {
        ...
        switch(contador18)
        {
            case 1: bandportugal.setImageResource(R.drawable.banportugal);
                imagenesmarcadas(bandportugal,"banportugal");
                almacenarimagenes("bandportugal","banportuga1");
                break;
            case 2: bandportugal.setImageResource(R.drawable.banportugal1);
                imagenesmarcadas(bandportugal,"banportugal1");
                almacenarimagenes("bandportugal","banportugal1");
                break;
            case 3: bandportugal.setImageResource(R.drawable.banportugal2);
                imagenesmarcadas(bandportugal,"banportugal2");
                almacenarimagenes("bandportugal","banportugal2");
                break;
        }
        if(contador18==3)
        {
    ...
    public void banarg (View view)
    {
        ...
        if(contador20==2)
        {
            banarg.setImageResource(R.drawable.banderaargentina1);
        ...
        if(contador20==3)
        {
            banarg.setImageResource(R.drawable.banderaargentina2);
